...
def create_hook_fns_analyze(start_grad_step):
    hook_fns_frequencies = [
        ...
        (0, utils.plot.hook_plot_compare_rnn_distilled_rnn_and_two_unit_rnn),
        ...
        (0, utils.plot.hook_plot_reduced_dim_behav_prob_correct_by_trial_within_block),
        (0, utils.plot.hook_plot_reduced_dim_behav_prob_correct_by_strength_trial_block),
