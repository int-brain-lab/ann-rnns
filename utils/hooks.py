...
def create_hook_fns_analyze(start_grad_step):
    hook_fns_frequencies = [
        ...
        (0, utils.plot.hook_plot_coupled_bayesian_observer_state_space_trajectories_within_block),
        ...
        (0, utils.plot.hook_plot_optimal_block_inference_multiple_blocks),
        (0, utils.plot.hook_plot_optimal_block_inference_single_block),
